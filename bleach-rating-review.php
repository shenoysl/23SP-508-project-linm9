<html>
<head>
<title>Bleach Rate/Review</title>
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    if(empty($checking)) {
        ...
        header("Location: bleach-info.php");
    }
    else{
...
body{
background-image: url('photos/ble.jpeg');
...
<body>
<div class = "goBack">
	<a href="bleach-info.php" type="goBack" class="goBack">Go Back</a>
</div>
	<div class="container mt-3 mb-3">
		<form method="post">
			<div class="row justify-content-center">
				<div class="col-4">
					<p class="sign" align="center">Rate & Review Bleach</p>
