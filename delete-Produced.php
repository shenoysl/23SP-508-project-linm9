...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlQuery = "DELETE FROM produced WHERE Anime_id = :Anime_id AND Producer_id = :Producer_id";
	...
	<div class="container mt-3 mb-3">
		<form method="post">
			<div class="row justify-content-center">
				<div class="col-4">
					<p class="sign" align="center">Remove Producer from Anime</p>
