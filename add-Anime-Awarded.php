...
if($_SERVER["REQUEST_METHOD"] == "POST") {
        $stmt = $conn->prepare("INSERT INTO anime_awarded (Anime_id, Anime_award_id, Year) VALUES (:Anime_id, :Anime_award_id, :Year)");        
	...
	<div class="container mt-3 mb-3">
		<form method="post">
			<div class="row justify-content-center">
				<div class="col-4">
					<p class="sign" align="center">Give Award to Anime</p>
					<div class="form-group">
						<input type="text" class="form-control" id="Anime_id" placeholder="Enter Anime_id" name="Anime_id" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="Anime_award_id" placeholder="Enter Anime Award ID" name="Anime_award_id" required>
					</div>
					<div class="form-group">
