<html>
<head>
<title>Delete Anime Awarded</title>
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlQuery = "DELETE FROM anime_awarded WHERE Anime_award_id = :Anime_award_id AND Anime_id = :Anime_id";
	...
	<div class="container mt-3 mb-3">
		<form method="post">
			<div class="row justify-content-center">
				<div class="col-4">
					<p class="sign" align="center">Delete from Anime Awarded</p>
